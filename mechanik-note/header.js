...
function initHeader() {
  ...
  let hideTimer;
  function hideHeader(){ header.style.opacity="0"; header.style.pointerEvents="none"; }
  function showHeader(){ header.style.opacity="1"; header.style.pointerEvents="auto"; clearTimeout(hideTimer); hideTimer=setTimeout(hideHeader,11000); }
